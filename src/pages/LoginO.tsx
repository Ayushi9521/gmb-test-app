    ...
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-500 to-purple-600 items-center justify-center p-6 xl:p-12">
        <div className="text-center text-white">
          <div className="mb-8">
            <div className="w-24 h-24 lg:w-32 lg:h-32 mx-auto bg-white/20 rounded-full flex items-center justify-center mb-6">
              <div className="w-16 h-16 lg:w-20 lg:h-20 bg-white rounded-lg flex items-center justify-center">
                <img src="https://member.gmbbriefcase.com/content/dist/assets/images/logo.png" alt="GMB Briefcase Logo" className="w-12 h-12 lg:w-16 lg:h-16 object-contain" />
              </div>
            </div>
          ...
          <h2 className="text-2xl lg:text-3xl font-bold mb-4">Welcome to GMB Briefcase</h2>
          <p className="text-white/80 text-sm lg:text-base">Your All-in-One Google Business Management Suite</p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-6 lg:p-8 bg-gray-50 min-h-screen lg:min-h-0">
        <div className="w-full max-w-md">
          <div className="mb-6 lg:mb-8">
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">GMB Briefcase</h1>
          ...
          <form className="space-y-4 sm:space-y-6" onSubmit={handleLogin}>
            ...
            <Button
              ...
              disabled={isLoading}
            >
              {isLoading ? <span className='flex items-center gap-2'><LoaderCircle className="animate-spin" />Logging in...</span> : "Log In"}
            </Button>
          </form>
        </div>
      </div>
