        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 mt-6">
          ...
          <div className="space-y-6">
            <HealthScoreCard 
              ...
              suggestions={[
                { type: 'photos', priority: 'high', description: 'Add 5+ recent photos' },
                { type: 'hours', priority: 'medium', description: 'Update business hours' },
                { type: 'posts', priority: 'low', description: 'Publish weekly updates' }
              ]}
            />
